...
window.onload = async () => {
    ...
    var ALL_EVENTS = [
        ...
        // Semester 2
        course_event(1, 0, "16:00", "19:00", "TMF326", "Π. Βατικιώτης",    "Ταυτότητα στον Κυβερνοχώρο: Μέσα Κοινωνικής Δικτύωσης και ακτιβισμός", "#4659B7"),
        course_event(1, 1, "16:00", "19:00", "TMF268", "Α. Καραδημητρίου", "Storytelling και αφήγηση στα Μέσα", "#B74659", null, "2025-03-04"),
        course_event(1, 1, "16:00", "19:00", "TMF299", "Ι. Βώβου",         "Σύγχρονο Επικοινωνιακό Περιβάλλον και Αρχαιολογία των Μέσων", "#B746B7", "2025-03-05"),
        course_event(1, 1, "19:00", "22:00", "TMF268", "Α. Καραδημητρίου", "Storytelling και αφήγηση στα Μέσα", "#B74659", "2025-03-05"),
