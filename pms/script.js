...
window.onload = async () => {
    ...
    var ALL_EVENTS = [
        ...
        course_event(1, 1, "16:00", "19:00", "TMF299", "Ι. Βώβου",         "Σύγχρονο Επικοινωνιακό Περιβάλλον και Αρχαιολογία των Μέσων", "#B746B7"),
        course_event(1, 1, "19:00", "22:00", "TMF268", "Α. Καραδημητρίου", "Storytelling και αφήγηση στα Μέσα" , "#B74659"),
        course_event(1, 2, "18:00", "21:00", "TMF273", "Β. Ρούγγας",       "Εισαγωγή στις Πρακτικές Δεδομένων", "#B7B746"),
        course_event(1, 4, "16:00", "19:00", "TMF280", "Γ. Μ. Κλήμης",     "Διοίκηση και Μάρκετινγκ", "#59B746")
